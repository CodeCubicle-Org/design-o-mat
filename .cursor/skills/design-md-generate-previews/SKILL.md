...
description: >-
  Runs the Node.js script generate-design-previews.mjs to emit preview.html and
  ...
  catalog, Phase 6, or light dark token board. Requires Node 18+. No Python.
---

# Design MD — generate previews (Phase 6)
...
2. From this repository root (where `package.json` and `generate-design-previews.mjs` live), run:
   - `npm run generate-previews` **or**
   - `node generate-design-previews.mjs <path-to-DESIGN.md> [--out <dir>]`
...
- **Node.js only** — [generate-design-previews.mjs](generate-design-previews.mjs); do not use Python.
